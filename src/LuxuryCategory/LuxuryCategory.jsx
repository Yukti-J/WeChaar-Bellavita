...
const LuxuryCategory = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <p className='text-3xl font-lexend pt-4'>LUXURY CATEGORIES</p>
      <Carousel className='min-[1050px]:w-[70%] w-[90%] mt-5' autoPlay infiniteLoop showStatus={false} showThumbs={false}>
        <div>
