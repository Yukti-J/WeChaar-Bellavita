...
const Home = () => {
  return (
    <>
      <div className="w-[100%] bg-gradient-to-r from-[#8F0060] via-[#12161C] to-[#3E162C] overflow-hidden min-[740px]:h-screen h-full">
        <Navbar
          search="bg-[#6D074C]"
        ...
        <div className="flex flex-col justify-center items-center min-[510px]:mt-20 mt-40 min-[510px]:pb-36 pb-44 max-[510px]:h-full">
          ...
          <img
            src={HomePerfume}
            alt="HomePerfume"
            className="min-[1040px]:h-[450px] min-[740px]:h-[350px] min-[510px]:h-[220px] h-[150px] min-[1040px]:-mt-52 min-[740px]:-mt-40 min-[510px]:-mt-28 -mt-14 z-10 opacity-95 perfume"
          />
          <img
            src={HomePerfume}
            alt="HomePerfume"
            className="min-[1040px]:h-[500px] min-[740px]:h-[400px] min-[510px]:h-[220px] h-[150px] min-[740px]:-mt-20 min-[510px]:-mt-20 -mt-10 z-0 opacity-20 -scale-y-90"
          />
