...
const Footer = () => {
  return (
    <div className='p-5'>
      <div className='bg-gradient-to-r from-[#04080F] to-[#8F0060] rounded-lg flex min-[1100px]:flex-row flex-col items-center justify-between py-10 px-16'>
        ...
        <div className='flex min-[580px]:flex-row flex-col text-white'>
            <div className="flex flex-col max-[510px]:items-center min-[730px]:mx-8 mx-2 mt-4">
                ...
                <ul className='font-lexend max-[510px]:text-center text-lg pl-2'>
                    <li>Shop</li>
                    <li>About</li>
                    <li>Blog</li>
                    <li>Contact</li>
