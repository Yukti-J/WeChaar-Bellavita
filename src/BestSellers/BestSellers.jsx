    ...
    <>
      <div className="w-[96%] m-auto shadow-fuchsia-800 shadow-md flex flex-col mt-10 mb-6 fadeanimation">
        ...
        <div className="my-8 grid justify-items-center min-[1020px]:grid-cols-3 min-[680px]:grid-cols-2 grid-cols-1 min-[1180px]:w-full min-[1180px]:justify-evenly mx-auto">
          <div className="border-4 border-bg-pink rounded-t-full min-[1180px]:w-[320px] w-[280px] mx-8 mt-4 hover:scale-105"
          style={{ transition: "all 0.4s ease-in-out" }}>
            <div className="p-5 min-[1180px]:pt-20 pt-14 flex justify-center">
              <img
                src={Product2}
                alt="Product2"
                className="min-[1180px]:h-[220px] h-[200px] min-[1180px]:mt-[60px] mt-[40px] min-[1180px]:mb-[20px] mb-[14px]"
              />
            </div>
          ...
          <div className="border-4 max-[1020px]:min-[680px]:col-span-2 col-span-1 border-bg-pink rounded-t-full min-[1180px]:w-[320px] w-[280px] mx-8 mt-4 hover:scale-105"
          style={{ transition: "all 0.4s ease-in-out" }}>
            <div className="p-5 min-[1180px]:pt-20 pt-14 flex justify-center">
              <img
                src={Product3}
